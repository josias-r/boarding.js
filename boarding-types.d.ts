import { HighlightElementStepLevelOptions, HighlightElementTopLevelOptions } from "./core/highlight-element";
import { OverlayTopLevelOptions } from "./core/overlay";
import { PopoverHybridOptions, PopoverStepLevelOptions, PopoverTopLevelOptions } from "./core/popover";
...
export interface BoardingOptions extends Partial<BoardingSharedOptions>, // partial because they will get default values
OverlayTopLevelOptions, PopoverHybridOptions, PopoverTopLevelOptions, HighlightElementTopLevelOptions {
    /**
...
export interface BoardingStepDefinition extends HighlightElementStepLevelOptions {
    /**
